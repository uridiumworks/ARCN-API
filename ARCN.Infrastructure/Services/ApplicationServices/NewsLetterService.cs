...
namespace ARCN.Infrastructure.Services.ApplicationServices
{
    public class NewsLetterService:INewsLetterService
    {
        ...
        public async ValueTask<ResponseModel<string>> AddNewsLetterAsync(NewsLetter model)
        {
            try
            {
        ...
        public async ValueTask<ResponseModel<string>> UpdateNewsLetterAsync(int NewsLetterid, NewsLetter model)
        {
            try
            {
